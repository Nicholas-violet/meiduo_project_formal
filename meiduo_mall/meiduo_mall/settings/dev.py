...
# print(BASE_DIR)
# 建立一个apps的导包路径，然后再一次的插入到系统导包路径列表中
apps_path = os.path.join(BASE_DIR, 'apps')
sys.path.insert(0, apps_path)
# 建立一个内层meiduo_mall的导包路径，然后再一次的插入到系统导包路径列表中
# apps_path = os.path.join(BASE_DIR, 'apps')
# sys.path.insert(0, apps_path)
...
SECRET_KEY = 'zbn8t(-#eit!hp%o%)3%w=t2-fpl-0#&a&_phm=k0%5b1ipzgv'
